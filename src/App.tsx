...
import { Product, CartItem, LegalTab } from './types';
import { fetchProducts, createOrder } from './lib/api';

export default function App() {
  // Products loaded from Supabase or fallback to hardcoded
  ...
  // Navigation & Active states: 'HOME' | 'SHOP' | 'ABOUT' | 'PRODUCT' | 'LEGAL'
  ...
  // Checkout handler — creates real order via Supabase
  ...
  // Group products for home carousels
  ...
  return (
    <div className="min-h-screen bg-white text-black font-inter-tight selection:bg-black selection:text-white flex flex-col">
      ...
      <main className="flex-1">
        {/* VIEW 1: DEDICATED PRODUCT DETAIL PAGE (PDP) */}
        {activeNav === 'PRODUCT' && selectedProduct ? (
          ...
          /* VIEW 2: FULL SHOP WITH COLLAPSIBLE FILTERS */
          <ShopPage
          ...
          /* VIEW 3: ABOUT PAGE & STORY OF BATIF STORE */
          <AboutPage
          ...
          <>
            ...
            <FadeInView>
              {/* "POLO EDITION" Split Hero Banner */}
              <PoloEditionSection
                onShopPolo={() => {
            ...
            <FadeInView>
              {/* Second "SHOP BY CATEGORY" Carousel */}
              <ShopByCategory
            ...
            <FadeInView>
              {/* NOIR ESSENTIALS Editorial Section */}
