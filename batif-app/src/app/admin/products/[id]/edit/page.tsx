      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className={cardClass}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2"><label className="flex items-center gap-2 cursor-pointer"><input type="checkbox" name="is_limited" checked={form.is_limited} onChange={handleFormChange} className="rounded border-gray-300 dark:border-gray-600 accent-[#FF5131]" /><span className="text-sm font-medium text-black dark:text-white">Limited Edition</span></label></div>
