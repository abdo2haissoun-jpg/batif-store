...
const BatifLogo = () => (
  <svg width="160" height="44" viewBox="0 0 879 439" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required
              className="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#FF5131] focus:border-transparent transition-all text-sm" />
          </div>
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-[#FF5131] text-white py-3 rounded-xl font-medium text-sm hover:bg-[#e6452a] disabled:opacity-50 transition-all">
