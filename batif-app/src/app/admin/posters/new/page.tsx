    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className={cardClass}>
          ...
          {/* Upload dropzone */}
          <label
            className="block border-2 border-dashed border-black/15 dark:border-white/15 hover:border-black/40 dark:hover:border-white/40 transition-colors cursor-pointer py-10 text-center"
          >
            <input
              ref={fileInputRef}
              type="file"
